#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""ptfx_blender_enerji.py — ENERJI ve SIVI sprite'larini Blender'da render eder.
...
Kullanim:
  python ptfx_blender_enerji.py --tur halka --cikti out.png
  python ptfx_blender_enerji.py --tur sicrama --cikti out.png --tohum 3
"""
