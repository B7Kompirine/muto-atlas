# ytd_find.ps1 - oyundaki TUM .ytd adlarini tarar, jenkins hash ile eslestirir.
#
...
#    sayilip sabit tahminlere dusuyordu. Anahtar adlari artik paths.ps1'de tek yerde.
