#!/usr/bin/env python3
"""komutlar.py -- plugin'in TUM komutlarini ve aciklamalarini listeler.
...
Kullanim:
  python scripts/komutlar.py                 # gruplanmis tam liste
  python scripts/komutlar.py --duz           # tek satirlik ad + aciklama
  python scripts/komutlar.py <arama>         # ada/aciklamaya gore filtre
"""
...
def main() -> int:
    ...
    print("  Plugin butunlugu    :  python scripts/denetle_plugin.py")
    print("  Tek satirlik liste  :  python scripts/komutlar.py --duz")
    print("  Arama               :  python scripts/komutlar.py <kelime>")
    return 0
