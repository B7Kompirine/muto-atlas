#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""ptfx_tezgah.py — oyundaki partikul testini DISARIDAN sur ve OLC.
...
Kullanim:
  python ptfx_tezgah.py tani            # numarali tani sayfalari
  python ptfx_tezgah.py hepsi           # 15 uretim efekti
  python ptfx_tezgah.py --olc <jpg>     # tek goruntuyu olc
"""
