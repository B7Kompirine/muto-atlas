#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""ptfx_quality_gate.py — uretilen `.ypt`yi VANILLA'ya karsi denetler.
...
Kullanim:
  python ptfx_quality_gate.py --grup virus_ambiyans
"""
...
from ptfx_build_catalog import GRUPLAR, VANILLA, CIKTI  # noqa: E402
from ptfx_motion import ALANLAR  # noqa: E402
