#!/usr/bin/env python3
"""ptfx_preview.py — derlenmis .ypt'den okunan VERIYLE animasyonlu onizleme.
...
Kullanim:
  python ptfx_preview.py <klasor> [--cikti onizleme.gif]
"""
...
def main():
    ...
    ap.add_argument("--cikti", default="ptfx_preview.gif")
