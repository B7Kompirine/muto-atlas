#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""ptfx_blender_smoke.py — HACIMSEL duman/ates/sis sprite'i render eder.

Uc kardes betigin ucuncusu:
  ptfx_blender_render.py   -> KATI parca   (beton/cam/tahta/kagit)
  ptfx_blender_energy.py   -> ENERJI+SIVI  (halka/yildiz/kure/damla/tac)
  ptfx_blender_smoke.py    -> HACIM        (duman/ates/sis/buhar)
...
Kullanim:
  python ptfx_blender_smoke.py --tur duman --cikti out.png
"""
