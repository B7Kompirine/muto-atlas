#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""ptfx_find_donor.py — transplant'a UYGUN vanilla donor bulur.
...
Kullanim:
  ...
  python ptfx_find_donor.py --ara concrete --ara glass      # alt dizge
"""
...
from ptfx_quality_gate import bloklari, kfp  # noqa: E402
