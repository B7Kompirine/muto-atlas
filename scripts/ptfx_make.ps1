# ptfx_make.ps1 — TEK KOMUTLA ozel partikul efekti uretir ve dagitir.
#
...
#   .\ptfx_make.ps1 -Ad my_spor -Renk 0.2,0.9,0.35 -Hedef <stream klasoru>
#
#   # kendi PNG'inden (gri maske: siyah zemin, sekil alfada)
#   .\ptfx_make.ps1 -Ad my_kelebek -Gorsel kelebek.png -Renk 0.15,0.6,1 `
