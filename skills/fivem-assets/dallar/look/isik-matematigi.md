...
**Kaynak:** `isik.md` §1-8, 'Blender önizlemesi', 'Sessiz hata kataloğu', 'Veri kurulumu' (2026-08) · **Ölçüm:** motorun shader kaynağı (`lighting_common.fxh`) port edildi; `pow()` sapması %17,3
**Önce:** `_dal.md` · gövde › `govde/arac-tuzaklari.md` §1-2 · araç `scripts/blender_light_preview.py`
