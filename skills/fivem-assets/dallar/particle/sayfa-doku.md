...
**Önce:** `dallar/particle/_dal.md` · `sifirdan-ypt.md` (dosyanın kendisi) · gövde › `govde/gta-temel.md` §5 doku
...
uygulamaz. Güvenli tavan **49 (7×7)** — hem `ptfx_sayfa.py` hem
...
### Çözüm: N emitter + `Unknown10` gecikmesi → `katmanli.md`
