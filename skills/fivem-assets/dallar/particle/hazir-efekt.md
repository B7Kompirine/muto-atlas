...
**Kaynak:** `govde/bayraklar.md` §6 · SKILL sorgu satırları (2026-08) · **Ölçüm:** 64.209 ytyp extension, 2.549 efekt / 368 `.ypt`; `ent_` öneki %65,3
...
4. ⭐ **`echo effect`** (FiveM helper resource) — efektleri **oyun içinde**
   ...
   (`kaynaklar/topluluk-kaynak.md` §11).
