...
**Önce:** `_branch.md` (el tag'leri, ORIGIN = kabza sözleşmesi) · gövde › `trunk/bone-tags.md` (tag ≠ indeks)
...
- Geçersiz bone index → prop entity'nin **merkezine** takılır, hata yok (resmi belge).
  Oyundaki görünümü: gövdenin yanında havada → `branches/map/mlo-props.md`.
