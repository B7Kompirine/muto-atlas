...
**Kaynak:** `decal.md` §0-3, §7-8, §10, beyaz/parlaklık · `trunk/flags.md` §8.5b-8.6 · eski `/look` · `decal-kaynak/KAYNAKLAR.md` (2026-08) · **Ölçüm:** 194 decal tipi; 4096 ışın merdivende; A oyunda çalıştı; 2.989 doku envanteri
