...
**Kaynak:** `lights.md` vertex color bölümleri + 'iç mekân kuralı' (morg MLO ölçümü, 2026-08) · **Ölçüm:** facility 66 dosya, vault, v_coroner kabuğu; 105 dosya geri okumayla
**Önce:** `_branch.md` · gövde › `trunk/tool-pitfalls.md` §1-2 · vanilla iç mekân bantları `branches/map/vanilla-interiors.md` §4
