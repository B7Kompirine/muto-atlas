---
name: fivem-assets
description: GTA V/FiveM prop, obje, kapı, ytyp/ymap/MLO, LOD, çim, bayrak, partikül, shader/doku/ışık/timecycle/decal/parallax, kıyafet, araç ve vanilla animasyon/kemik verisine erişim. Bir prop/obje/kapı/harita/efekt/görünüm işiyle ilgili KOD YAZMADAN ÖNCE bu skill ile gerçek asset verisine bakılır. Kullanıcı bir objeyi hareket ettirmek, kapı açmak/kilitlemek, prop spawn etmek, vanilla animasyon oynatmak, ymap/ytyp/MLO ile uğraşmak, efekt/ışık/doku/decal ayarlamak, kıyafet eklemek ya da yıkım sahnesi kurmak istediğinde MUTLAKA devreye gir — kullanıcı "skill" demese bile. Model adı geçen (v_ilev_*, prop_*, p_*, ch_prop_*, des_*), "kapı açılmıyor", "obje kımıldamıyor", "freeze", "AddDoorToSystem", "TaskPlayAnim", "anim dict", "hangi animasyon", "bu prop var mı", "bone tag", "GetPedBoneIndex", "DUI", "3D NUI", "CreateDui", "AddReplaceTexture", "render target", "ATM ekranı", "fragment", "kırılabilir", "ele tutturma", "partikül", "particle", "ptfx", "efekt", "duman", "ateş", "kıvılcım", "StartParticleFx", "core.ypt", "flipbook", "LOD", "lodDist", "uzakta kayboluyor", "flicker", "ytyp bayrağı", "ymap bayrağı", "specialAttribute", "1572872", "18350080", "extension", "çim", "grass", "Procedural ID", "@ma", "Gen9", "target_formats", "CWXML", "araç", "vehicle", "handling", "modkit", "SetVehicleExtra", "ped meta", "MLO listesi", "IPL", "RequestIpl", "loot noktası", "ATM nerede", "dünya nesnesi", "decal", "graffiti", "AddDecal", "render bucket", "timecycle", "karanlık", "TimeFlags", "Flashiness", "ışık yanmıyor", "emissive", "parallax", "pxm", "heightScale", "vanilla iç mekân", "bevel", "shader", "DDS", "bake", "kıyafet", "giysi", "skintone", "ped prop", "ped cloth", "yıkım", "RayFire", "köprü", "Sollumz", "CodeWalker" geçen her görevde kullan.
---
