...
**Gövde dosyası.** Bir asset'i oyuna sokmadan doğrulamanın merdiveni; her dal bunu kullanır. Taşındı: `govde/dogrulama-merdiveni.md` (2026-09-05).
...
## Tablonun kendisini doğrulama — `dogrula_tablolar.py`
...
```bash
python "${CLAUDE_PLUGIN_ROOT}/scripts/dogrula_tablolar.py"
```
