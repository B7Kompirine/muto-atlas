...
**Gövde dosyası.** Araç / silah / ped kemiklerinde ad mı sabit, tag mi sabit — üç dala birden hizmet eder. Taşındı: `govde/kemik-tag.md` (2026-09-05).
...
- **Sollumz `Flags` alanını sıfır bırakır**; sıfır bayraklı kemik hiçbir
  ...
  klipten türet — bkz. `dallar/map/yikim.md` §Bağ D. (CLAUDE.md §1.5)
...
| ytyp/ymap bayrağı | `govde/bayraklar.md` (§2.1 gerçek dağılım) |
